...
const Villa = () => {
    ...
    return (
        <>
            ...
            >
                <Form >
                    <h1 className="text-center">Villa Creating</h1>
                    <div className="content">
                        ...
                        <div className="mt-4 ms-5">Pool Area</div>
                        <Field type="text" name="pool_area" className="d-block w-50" style={{ margin: "0 auto", padding: "3px 8px" }} />
                        <ErrorMessage name='pool_area' component='small' className='validate-failed' />
                    </div>
